...
function ProductionStepper({ steps, onUpdateStep, clientPhone, clientName, phoneCountryCode, onGeneratePdf }) {
  ...
  return (
    ...
    `}>
      ...
      {/* ============================================================ */}
      {/* CONTENEUR D'ACTIONS FIXE — Bas de page */}
      {/* ============================================================ */}
      <div className="sticky bottom-0 z-30 bg-white border-t border-stone-200 px-6 py-4 no-print
                      shadow-[0_-4px_20px_rgba(0,0,0,0.08)]">
        <div className="flex items-center gap-3">
          {/* Bouton Notifier le Client — WhatsApp */}
          <button
            onClick={handleWhatsApp}
            disabled={!clientPhone}
            className={`
              flex-1 py-4 font-semibold text-xs uppercase tracking-[0.2em]
              transition-all duration-300 flex items-center justify-center gap-3
              ${clientPhone
                ? 'hover:opacity-90 shadow-lg hover:shadow-xl hover:-translate-y-0.5'
          ...
          <button
            ...
            className="flex-1 py-4 bg-stone-900 text-white font-semibold text-xs uppercase tracking-[0.2em]
                       hover:bg-stone-800 transition-all duration-300 shadow-lg hover:shadow-xl
                       hover:-translate-y-0.5 flex items-center justify-center gap-3"
            style={{ borderRadius: '0' }}
          >
